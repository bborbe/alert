...
import (
	...
	monitoringbenjaminborbedev1 "github.com/bborbe/alert/k8s/client/clientset/versioned/typed/monitoring.benjamin-borbe.de/v1"
	gentype "k8s.io/client-go/gentype"
)

// fakeAlerts implements AlertInterface
type fakeAlerts struct {
	*gentype.FakeClientWithList[*v1.Alert, *v1.AlertList]
	Fake *FakeMonitoringV1
}

func newFakeAlerts(fake *FakeMonitoringV1, namespace string) monitoringbenjaminborbedev1.AlertInterface {
	return &fakeAlerts{
		gentype.NewFakeClientWithList[*v1.Alert, *v1.AlertList](
			fake.Fake,
			namespace,
