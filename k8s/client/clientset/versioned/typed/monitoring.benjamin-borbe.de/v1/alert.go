...
import (
	...
	applyconfigurationmonitoringbenjaminborbedev1 "github.com/bborbe/alert/k8s/client/applyconfiguration/monitoring.benjamin-borbe.de/v1"
...
type AlertInterface interface {
	...
	Apply(ctx context.Context, alert *applyconfigurationmonitoringbenjaminborbedev1.AlertApplyConfiguration, opts metav1.ApplyOptions) (result *monitoringbenjaminborbedev1.Alert, err error)
	AlertExpansion
}

// alerts implements AlertInterface
type alerts struct {
	*gentype.ClientWithListAndApply[*monitoringbenjaminborbedev1.Alert, *monitoringbenjaminborbedev1.AlertList, *applyconfigurationmonitoringbenjaminborbedev1.AlertApplyConfiguration]
}

// newAlerts returns a Alerts
func newAlerts(c *MonitoringV1Client, namespace string) *alerts {
	return &alerts{
		gentype.NewClientWithListAndApply[*monitoringbenjaminborbedev1.Alert, *monitoringbenjaminborbedev1.AlertList, *applyconfigurationmonitoringbenjaminborbedev1.AlertApplyConfiguration](
			"alerts",
			c.RESTClient(),
