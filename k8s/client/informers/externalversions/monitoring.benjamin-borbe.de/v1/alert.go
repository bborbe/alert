...
import (
	...
	apismonitoringbenjaminborbedev1 "github.com/bborbe/alert/k8s/apis/monitoring.benjamin-borbe.de/v1"
	...
	monitoringbenjaminborbedev1 "github.com/bborbe/alert/k8s/client/listers/monitoring.benjamin-borbe.de/v1"
...
type AlertInformer interface {
	...
	Lister() monitoringbenjaminborbedev1.AlertLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MonitoringV1().Alerts(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitoringV1().Alerts(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitoringV1().Alerts(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitoringV1().Alerts(namespace).Watch(ctx, options)
			},
		}, client),
		&apismonitoringbenjaminborbedev1.Alert{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *alertInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismonitoringbenjaminborbedev1.Alert{}, f.defaultInformer)
}

func (f *alertInformer) Lister() monitoringbenjaminborbedev1.AlertLister {
	return monitoringbenjaminborbedev1.NewAlertLister(f.Informer().GetIndexer())
}
